  ...
  <body>
    <form id="form1">
      <table width="100%" border="0" cellspacing="1" cellpadding="5">
        <tbody>
          <tr>
            <td style="width: 57px">&nbsp; &nbsp;游戏:</td>
            <td style="width: 107px">
              <select
                name="drdGame"
                id="drdGame"
                style="width: 110px; font-size: 10pt"
              >
                <option selected="selected" value="1">百家乐一</option>
